...
void BSP_GPIO_Initial(void)
{
    ...
    //case
    GPIO_Init(PORT_L01_case, PIN_L01_case, GPIO_Mode_Out_PP_High_Slow);
    GPIO_ResetBits(PORT_L01_case, PIN_L01_case);
}
/*!
...
/*!
 *  @brief        Register the UART Cycle FIFO£ºUart_TxBuffer,Uart_RxBuffer
 *  @note
*/
...
/*!
 *  @brief        Read from the UART FIFO£ºUart_TxBuffer,Uart_RxBuffer
 *  @param        mode£ºUART_TX->Uart_TxBuffer,UART_RX->Uart_RxBuffer
...
/*!
 *  @brief        Write to the UART FIFO£ºUart_TxBuffer,Uart_RxBuffer
 *  @param        mode£ºUART_TX->Uart_TxBuffer,UART_RX->Uart_RxBuffer
 *  @param        buffer£ºthe buffer to be written
 *  @param        size£ºthe size to be written
 *  @return       None
 *  @note
*/
...
/*!
 *  @brief        Write a byte to the UART FIFO£ºUart_TxBuffer,Uart_RxBuffer
 *  @param        mode£ºUART_TX->Uart_TxBuffer,UART_RX->Uart_RxBuffer
 *  @param        value£ºthe value to be written
 *  @return
 *  @note
*/
...
/*!
 *  @brief        Read a byte from the UART FIFO£ºUart_TxBuffer,Uart_RxBuffer
 *  @param        mode£ºUART_TX->Uart_TxBuffer,UART_RX->Uart_RxBuffer
 *  @return
 *  @note
*/
...
/*!
 *  @brief        Get the UART FIFO's valid size£ºUart_TxBuffer,Uart_RxBuffer
 *  @param        mode£ºUART_TX->Uart_TxBuffer,UART_RX->Uart_RxBuffer
 *  @return       valid_size
 *  @note
*/
...
/*!
 *  @brief        Discard the UART FIFO's data£ºUart_TxBuffer,Uart_RxBuffer
 *  @param        mode£ºUART_TX->Uart_TxBuffer,UART_RX->Uart_RxBuffer
 *  @return
 *  @note
*/
